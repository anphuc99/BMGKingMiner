...
this.addValueDef("PlayerItem", {
    ...
    {idPlayer = this.platformUserId, idItem = "myplugin/H_non_1_2",cellNum = 1, num = 1, position = positionItem.balo},
    {idPlayer = this.platformUserId, idItem = "myplugin/S_ao_1_2",cellNum = 2, num = 1, position = positionItem.balo},
    {idPlayer = this.platformUserId, idItem = "myplugin/T_quan_1_2",cellNum = 3, num = 1, position = positionItem.balo},
